...
1.  АРХИТЕКТУРА РАСПРЕДЕЛЁННЫХ БАЗ ДАННЫХ НА ОСНОВЕ ТЕХНОЛОГИИ
    BLOCKCHAIN
...
![](media/image2.jpeg){width="6.229154636920385in"
...
1.  Голосование в распределённых анонимных сетях
...
1.  Публично проверяемые доказательства
...
1.  Аутентификация новых записей
...
1.  Частота появления блоков данных
